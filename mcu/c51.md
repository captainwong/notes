...
回调函数的参数过多，无法通过寄存器传参，可以定义一个结构体把参数包起来传递，只需 `R1-R3` 3个寄存器.

- [C51: Passing Parameters to Indirectly Called Functions](https://developer.arm.com/documentation/ka004078/latest)
- [Parameters and Registers](https://developer.arm.com/documentation/101655/0961/Cx51-User-s-Guide/Language-Extensions/Function-Declarations/Parameters-and-Registers)
